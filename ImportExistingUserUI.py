...
from importExisting import main

class ImportExistingUserUI(object):
...
"}")
    ...
    def insertToDatabase(self):
        if self.file_name[0]:
            try:
                ...
                msg.setText("Existing Users Imported!")
                ...
                msg.setText("There is a Problem in the Script")
            ...
            msg = QMessageBox()
            msg.setWindowTitle("Error!")
            msg.setText("There is a problem in the GUI Program.")
            msg.setIcon(QMessageBox.Warning)
            msg.setStandardButtons(QMessageBox.Ok)
            x = msg.exec_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.title.setText(_translate("MainWindow", "Import Existing User"))
        self.pathToImportCsvEntry.setPlaceholderText(_translate("MainWindow", "path/to/NewUPGoogleUsers.csv"))
